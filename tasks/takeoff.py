...
class Takeoff(BaseTask):
    ...
    def __init__(self):
        ...
        self.action_space = spaces.Box(
            ...
            np.array([max_force/10, max_force/10,  max_force, max_torque/10, max_torque/10,  max_torque]))
    ...
    def reset(self):
        self.p = (0.0, 0.0, 0.0 +  np.random.normal(0.5, 0.1))
    ...
    def update(self, timestamp, pose, angular_velocity, linear_acceleration):
        ...
        #velocity = self.compute_velocity(pose.position, timestamp)
        reward, done = self.calculate_reward(timestamp, pose)
